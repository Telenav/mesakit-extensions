...
public class PlaceRenderer
{
    ...
    private void draw(final RenderPass pass, final Place place)
    {
        ...
        if (canvas.scale().closerThan(Scale.STATE) || place.isCity() || place.population().isGreaterThan(Count.of(10_000)))
        {
            ...
            if (pass == RenderPass.DOT)
            {
                ...
                final var normal = new Dot(width, PLACE, width.scaled(Percentage.of(10)), PLACE);
