...
public class RectangleGsonSerializer extends BaseGsonStringSerializer<Rectangle>
{
    ...
    @Override
    protected Rectangle onDeserialize(String serialized)
    {
        return Rectangle.parse(serialized);
    }
}
